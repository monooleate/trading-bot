...
- **Nyitott jelöltek (jóváhagyásra, discovery §7 A-lépcső):** #2–#8 LIVE bekapcsolása (a mérés + pozitív gain után); #4 online AdaHedge + ADWIN/BOCPD regime-reset — kötődik **B34**; #5 HAR-RV (Yang–Zhang) vol-motor; #6 first-passage routing touch-piacokra; #7 Deribit SSVI+BL benchmark-signal; #8 disagreement-gated extremizing; #9 sports Pinnacle de-vig — **= B37**.
