...
| **Migrációs runbook** (Netlify→analytics, fázis-terv a köv. sessionnek: repo-restrukturálás → Blobs→Postgres → deploy → cutover → B-lépcső ML + kickoff-prompt) | [`migration-runbook.md`](./migration-runbook.md) | A topológia+compose a `hetzner-docker-setup.md` §18; az absztrakt 7-fázis a `hetzner-migration.md` |
