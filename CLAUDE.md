...
**Operátor-döntést kér:** (1) a **sports élőben FUT** (3 nyitott pozíció) a 2026-07-23-i dokumentált stop ellenére — a kód-okokat javítottam (a stop már túléli a hibát/séma-bumpot, van tartós `sportsCronEnabled`), de az **élő sessionhöz nem nyúltam**; (2) a knobok élesítése (mind default-OFF); (3) P3-16 log-megőrzés (infra); (4) deploy — a munka branchen áll, `main`-re push automatikusan deployol. Doksi: [sprints B58–B65](internal-docs/roadmap/sprints.md) · [changelog](internal-docs/changelog/CHANGELOG-2026-09-09.md).
