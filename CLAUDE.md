...
| **F-Arb** | $200 → **$196.45** (shared HL) | $0 | 0 closed | 0 open | **05-29 élő**: cron fut (5 coin / 3 min), 0 trade (a spreadek negatívak/küszöb-alattiak). **Sprint 44**: bidirekcionális lett — a **reverse arb** (negatív spread, HL-long + Binance-short, carry = −spread) **paperben aktív**, live-gated (Binance futures-short kell → B20). |
